...
@section('title', 'Cadastro de Cliente - PDV Easy')
...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between pb-5 border-b border-slate-200">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Cadastro de Novo Cliente</h1>
            <p class="text-sm text-slate-500 font-light mt-1">Insira as informações do cliente para a gestão de fidelidade, controle de crédito e faturamento.</p>
        </div>
    ...
    @if ($errors->any())
        <div class="p-4 bg-rose-50 border border-rose-100 text-rose-700 rounded-2xl flex items-start space-x-3.5 shadow-sm">
            ...
            <div>
                <h4 class="text-xs font-bold text-rose-950">Não foi possível salvar o cliente:</h4>
                ...
                <div class="flex items-center bg-slate-100 p-1 rounded-xl w-fit border border-slate-200/40">
                    <label class="relative flex items-center justify-center px-4 py-2 rounded-lg text-xs font-bold cursor-pointer transition-all duration-200 select-none" id="label-pf">
                        <input type="radio" name="tipo_cliente" value="PF" class="sr-only" 
                            {{ old('tipo_cliente', 'PF') === 'PF' ? 'checked' : '' }} onchange="toggleClientType('PF')">
                    ...
                    <label class="relative flex items-center justify-center px-4 py-2 rounded-lg text-xs font-medium text-slate-600 cursor-pointer transition-all duration-200 select-none" id="label-pj">
                        <input type="radio" name="tipo_cliente" value="PJ" class="sr-only" 
                            {{ old('tipo_cliente') === 'PJ' ? 'checked' : '' }} onchange="toggleClientType('PJ')">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="documento" id="documento" required placeholder="000.000.000-00" value="{{ old('documento') }}"
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="nome" id="nome" required placeholder="Digite o nome completo" value="{{ old('nome') }}"
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="apelido" id="apelido" placeholder="Apelido ou nome social" value="{{ old('apelido') }}"
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="registro_geral" id="registro_geral" placeholder="Número do RG" value="{{ old('registro_geral') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <select name="tipo_contribuinte" id="tipo_contribuinte"
                            ...
                            <option value="não_contribuinte" {{ old('tipo_contribuinte') === 'não_contribuinte' ? 'selected' : '' }}>Não Contribuinte</option>
                            <option value="contribuinte_icms" {{ old('tipo_contribuinte') === 'contribuinte_icms' ? 'selected' : '' }}>Contribuinte ICMS</option>
                            <option value="isento" {{ old('tipo_contribuinte') === 'isento' ? 'selected' : '' }}>Isento</option>
                        </select>
                    </div>
                        ...
                        <div class="flex items-center justify-between p-3.5 bg-slate-50 border border-slate-200 rounded-xl transition-all hover:bg-slate-100/50">
                            ...
                            <label class="inline-flex relative items-center cursor-pointer select-none">
                                <input type="checkbox" name="consumidor_final" id="consumidor_final" class="sr-only peer"
                                    {{ old('consumidor_final', session()->has('errors') ? 'off' : 'on') === 'on' ? 'checked' : '' }}>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="telefone_fixo" id="telefone_fixo" placeholder="(00) 0000-0000" value="{{ old('telefone_fixo') }}"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="telefone_celular" id="telefone_celular" placeholder="(00) 00000-0000" value="{{ old('telefone_celular') }}"
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="email" name="email" id="email" required placeholder="exemplo@dominio.com" value="{{ old('email') }}"
            ...
            <div class="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="text" name="cep" id="cep" required placeholder="00000-000" maxlength="9" value="{{ old('cep') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div class="md:col-span-3 space-y-1.5">
                        ...
                        <input type="text" name="logradouro" id="logradouro" required placeholder="Ex: Rua, Avenida, etc" value="{{ old('logradouro') }}"
                    ...
                    <div class="md:col-span-1 space-y-1.5">
                        ...
                        <input type="text" name="numero" id="numero" required placeholder="Nº" value="{{ old('numero') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="complemento" id="complemento" placeholder="Apt, Bloco, etc" value="{{ old('complemento') }}"
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="col-span-0.5 space-y-1.5">
                        ...
                        <input type="text" name="uf" id="uf" placeholder="UF" maxlength="2" value="{{ old('uf') }}"
                    ...
                    <div class="col-span-1 space-y-1.5">
                        ...
                        <input type="text" name="ibge" id="ibge" placeholder="Cód. IBGE" value="{{ old('ibge') }}"
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const selectedType = "{{ old('tipo_cliente', 'PF') }}";
